# [3.1 ROS2节点介绍](https://fishros.com/d2lros2foxy/#/chapt3/3.1ROS2节点介绍?id=_31-ros2节点介绍)

本节主要给大家介绍节点，不知道有多少小伙伴看了第一章的扩展阅读，小鱼通过ROS镇长的小故事来和大家讲解了ROS的通信机制。

## [1. ROS2节点是什么](https://fishros.com/d2lros2foxy/#/chapt3/3.1ROS2节点介绍?id=_1-ros2节点是什么)
...
![image-20210915153915430](assets/image-20210915153915430.png)

## [2.节点之间如何交互？](https://fishros.com/d2lros2foxy/#/chapt3/3.1ROS2节点介绍?id=_2节点之间如何交互？)
...
官方给了一张图，大家先大概看一下，帮助理解![Nodes-TopicandService](assets/Nodes-TopicandService.gif)

## [3. 如何启动一个节点？](https://fishros.com/d2lros2foxy/#/chapt3/3.1ROS2节点介绍?id=_3-如何启动一个节点？)
...
## [4. 通过命令行界面查看节点信息](https://fishros.com/d2lros2foxy/#/chapt3/3.1ROS2节点介绍?id=_4-通过命令行界面查看节点信息)

### [4.1 ROS2命令行](https://fishros.com/d2lros2foxy/#/chapt3/3.1ROS2节点介绍?id=_41-ros2命令行)
...
### [4.2 节点相关的CLI](https://fishros.com/d2lros2foxy/#/chapt3/3.1ROS2节点介绍?id=_42-节点相关的cli)
...
## [5.总结](https://fishros.com/d2lros2foxy/#/chapt3/3.1ROS2节点介绍?id=_5总结)
