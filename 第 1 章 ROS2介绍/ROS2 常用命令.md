...
| 功能         | 命令                                          | 说明               |
| ------------ | --------------------------------------------- | ------------------ |
| 查看服务列表 | `ros2 service list`                           | 显示所有服务       |
| 查看服务类型 | `ros2 service type /service`                  | 查看服务接口类型   |
| 调用服务     | `ros2 service call /service type "{request}"` | 发送请求并等待响应 |

```shell
ros2 service call /borrow_money village_interfaces/srv/BorrowMoney "{money: 10}"
```
