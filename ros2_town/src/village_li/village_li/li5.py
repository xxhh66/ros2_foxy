...
class WriterNode(Node):
    ...
    def __init__(self,name):
        ...
        # 第一个是方法类型，第二个是话题名称 sexy_girl，第三个是消息队列长度 10
    ...
    def timer_callback(self):
        ...
        self.get_logger().info('李5:我create_subscription发布了艳娘传奇："%s"' % msg.data)    #打印一下发布的数据，供我们看
        self.i += 1 #章节编号+1
    ...
    def recv_money_callback(self,money):
        ...
        self.get_logger().info('李5:我已经收到了%d的稿费' % self.account)
