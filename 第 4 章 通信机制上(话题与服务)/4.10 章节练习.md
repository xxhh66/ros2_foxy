# [自定义话题通信（小说+插图）](https://fishros.com/d2lros2foxy/#/chapt4/4.11自定义话题通信(python)?id=自定义话题通信（小说插图）)
...
## [1. 准备工作](https://fishros.com/d2lros2foxy/#/chapt4/4.11自定义话题通信(python)?id=_1-准备工作)
...
## [2. 代码编写](https://fishros.com/d2lros2foxy/#/chapt4/4.11自定义话题通信(python)?id=_2-代码编写)

**修改头文件**

在`village_li`的`li4`节点中引入以下头文件
...
## [3. 编译功能包](https://fishros.com/d2lros2foxy/#/chapt4/4.11自定义话题通信(python)?id=_3-编译功能包)
...
## [4. 运行节点](https://fishros.com/d2lros2foxy/#/chapt4/4.11自定义话题通信(python)?id=_4-运行节点)
...
![image-20210910163422495.png](https://fishros.com/d2lros2foxy/chapt4/4.11自定义话题通信(python)/imgs/image-20210910163422495.png)
...
![image-20210910191451914.png](https://fishros.com/d2lros2foxy/chapt4/4.11自定义话题通信(python)/imgs/image-20210910191451914.png)
